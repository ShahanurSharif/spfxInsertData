...
var InsertDataWebPart = function (props) {
    ...
    return (React.createElement("div", null,
        ...
        !showForm && successMessage && (React.createElement("div", { role: "alert", "data-testid": "success-message", style: { color: 'green', margin: '12px 0' } }, successMessage)),
        !showForm && errorMessage && (React.createElement("div", { role: "alert", "data-testid": "error-message", style: { color: 'red', margin: '12px 0' } }, errorMessage)),
