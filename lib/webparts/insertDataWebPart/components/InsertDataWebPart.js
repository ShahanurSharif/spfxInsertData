...
var InsertDataWebPart = function (props) {
    ...
    var _h = React.useState(), bodyError = _h[0], setBodyError = _h[1];
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Dialog, { hidden: !showForm, onDismiss: function () { return setShowForm(false); }, dialogContentProps: {
            ...
            React.createElement("form", { onSubmit: handleSubmit },
                successMessage && (React.createElement("div", { role: "alert", "data-testid": "success-message", style: { marginBottom: 8, color: 'green' } }, successMessage)),
                errorMessage && (React.createElement("div", { role: "alert", "data-testid": "error-message", style: { marginBottom: 8, color: 'red' } }, errorMessage)),
                ...
                titleError && (React.createElement("div", { id: "title-error", role: "alert", "data-testid": "title-error", style: { color: 'red', minHeight: 18 } }, titleError)),
                ...
                bodyError && (React.createElement("div", { id: "body-error", role: "alert", "data-testid": "body-error", style: { color: 'red', minHeight: 18 } }, bodyError)),
                ...
                letterError && (React.createElement("div", { id: "letter-error", role: "alert", "data-testid": "letter-error", style: { color: 'red', minHeight: 18 } }, letterError)),
        ...
        successMessage && (React.createElement("div", { role: "alert", "data-testid": "success-message", style: { color: 'green', margin: '12px 0' } }, successMessage)),
        errorMessage && (React.createElement("div", { role: "alert", "data-testid": "error-message", style: { color: 'red', margin: '12px 0' } }, errorMessage)),
            ...
            React.createElement("tbody", null,
                faqItems.map(function (item) { return (React.createElement("tr", { key: item.Id },
                    ...
                    React.createElement("td", { style: { borderBottom: '1px solid #eee' } },
                        React.createElement("button", { type: "button", "aria-label": "Edit", "data-testid": "edit-button-".concat(item.Id), onClick: function () { return handleEdit(item); }, style: { marginRight: 8 } },
                            React.createElement("span", { role: "img", "aria-label": "Edit", style: { marginRight: 4 } }, "\u270F\uFE0F"),
                            "Edit"),
                        React.createElement("button", { type: "button", "aria-label": "Delete", "data-testid": "delete-button-".concat(item.Id), onClick: function () { return handleDelete({ Id: item.Id, Title: item.Title }); } },
                            React.createElement("span", { role: "img", "aria-label": "Delete", style: { marginRight: 4 } }, "\uD83D\uDDD1\uFE0F"),
                            "Delete")))); }),
