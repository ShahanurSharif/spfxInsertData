...
describe('InsertDataWebPart', function () {
    ...
    it('shows validation errors if required fields are empty after blur', function () { return __awaiter(void 0, void 0, void 0, function () {
        var titleInput, descriptionInput, letterDropdown, alerts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(alerts.some(function (a) { var _a; return (_a = a.textContent) === null || _a === void 0 ? void 0 : _a.match(/Description is required/i); })).toBe(true);
                ...
                case 0:
                    ...
                    window.fetch = jest.fn()
                        ...
                        return Promise.resolve({
                            ok: true,
                            json: function () { return Promise.resolve({ Id: 1, Title: fakeTitle, Body: fakeTitle, Letter: 'A' }); }
                        });
                    })
                        ...
                        return Promise.resolve({
                            ok: true,
                            json: function () { return Promise.resolve({ value: [{ Id: 1, Title: fakeTitle, Body: fakeTitle, Letter: 'A' }] }); }
                        });
                    });
                    render(React.createElement(InsertDataWebPart, __assign({}, mockProps)));
                    userEvent.click(screen.getByText('Create Item'));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    window.fetch = jest.fn(function () { return Promise.resolve({ ok: false }); });
                    userEvent.click(screen.getByText('Submit'));
                    _a = expect;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    window.fetch = jest.fn(function () {
                        return Promise.resolve({
                            ok: true,
                            json: function () { return Promise.resolve({ Id: 1, Title: 'Test Title', Body: 'Test Description', Letter: 'A' }); }
                        });
                    });
                    render(React.createElement(InsertDataWebPart, __assign({}, mockProps)));
                    userEvent.click(screen.getByText('Create Item'));
                ...
                case 2:
                    ...
                    _a = expect;
                    return [4 /*yield*/, screen.findByText('Test Title Updated')];
                case 3:
                    // Verify the updated item appears
                    _a.apply(void 0, [_b.sent()]).toBeInTheDocument();
                    return [2 /*return*/];
    ...
    it('renders edit and delete buttons with correct data-testid and allows extracting item Id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeTitle, itemRow, row, editButton, editButtonPattern, dataTestId, idMatch, itemId, deleteButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    render(React.createElement(InsertDataWebPart, __assign({}, mockProps)));
                ...
                case 3:
                    ...
                    row = itemRow.closest('tr');
                    editButton = row && row.querySelector('[data-testid^="edit-button-"]');
                    expect(editButton).not.toBeNull();
                    // userEvent.click requires a non-null Element, so cast is safe after the check
                    userEvent.click(editButton);
                    return [4 /*yield*/, screen.findByTestId(/^edit-button-\d+$/)];
                case 4:
                    editButtonPattern = _a.sent();
                    expect(editButtonPattern).toBeInTheDocument();
                    dataTestId = editButtonPattern.getAttribute('data-testid');
