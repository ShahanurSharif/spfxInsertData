...
describe('InsertDataWebPart', function () {
    ...
    it('shows validation errors if required fields are empty', function () { return __awaiter(void 0, void 0, void 0, function () {
        var alerts;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    userEvent.click(screen.getByText('Submit'));
                    _a = expect;
                    return [4 /*yield*/, screen.findByText('Item created successfully')];
                case 2:
    ...
    it('edits an item successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeTitle, newFakeTitle, titleInput, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    render(React.createElement(InsertDataWebPart, __assign({}, mockProps)));
                ...
                case 1:
                    ...
                    newFakeTitle = faker.lorem.sentence();
                    titleInput = screen.getByLabelText('Title');
                    userEvent.clear(titleInput);
                    userEvent.type(titleInput, newFakeTitle);
                    userEvent.click(screen.getByText('Submit'));
                    _a = expect;
                    return [4 /*yield*/, screen.findByText('Item updated successfully')];
                case 2:
                    _a.apply(void 0, [_b.sent()]).toBeInTheDocument();
